...
class item2(models.Model):
    ...
    title = models.CharField(max_length=500 , default=1)
    slug = models.SlugField(unique=True, default=1)
    ...
    i_image = models.ImageField(upload_to='shop2/images2', default="")
...
class CartProduct(models.Model):
    ...
    product = models.ForeignKey(item2, on_delete=models.CASCADE)
